    ...
    <>
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-600/20 to-orange-500/20 rounded-full blur opacity-50"></div>
            ...
            <div className="relative flex items-center gap-1">
              ...
              <a
                ...
                >
                  <Button
                    size="sm"
                    className="ml-2 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-600 border-0"
                  >
                    Resume
                  </Button>
                </a>
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <Button className="mt-6 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-600 border-0">
                Resume
              </Button>
            </a>
